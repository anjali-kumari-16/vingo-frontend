...
function Nav() {
  ...
  return (
    <div className="w-full h-[80px] flex items-center justify-between md:justify-center gap-[30px] p-[20px] fixed top-0 z-[9999] bg-[#fff9f6]">
      {showSearch && (
        <div className="w-[90%] h-[70px] bg-white shadow-xl rounded-lg items-center gap-[20px] flex fixed top-[80px] left-[5%]">
          <div className="flex items-center w-[30%] overflow-hidden gap-[10px] px-[10px] border-r-[2px] border-gray-400">
            ...
            <div className="w-[80%] truncate text-gray-600">Jamshedpur</div>
          </div>
      ...
      <h1 className="text-4xl font-bold mb-2 text-[#ff4d2d]">PetPuja</h1>
